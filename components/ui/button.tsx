...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-button-blue text-white shadow hover:bg-button-blue/80 h-9 px-4 py-2 lg:h-10 lg:px-8 font-bold text-lg",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 ",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-button-light-gray text-black shadow-sm hover:bg-button-light-gray/20 dark:bg-button-dark-gray dark:text-white dark:hover:bg-button-dark-gray/20 h-9 px-4 py-2 lg:h-10 lg:px-8",
